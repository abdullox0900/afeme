...
function PartnersInner() {
    ...
    useEffect(() => {
        axios.get(`https://ali98.uz/api/partnericons`)
            .then(res => {
                                    ...
                                    return (
                                        <>
                                            <li className="portners-inner__item">
                                                <a className="portners-innner__link" href={img.url}>
                                                    <img className="portners-inner__img" src={img.icon} alt="img" width={150} height={100} />
                                                </a>
                                            </li>
                                        </>
                                    )
